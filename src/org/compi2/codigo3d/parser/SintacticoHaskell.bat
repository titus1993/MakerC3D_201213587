...
java -jar C:\Users\Titus\Documents\NetBeansProjects\MakerC3D_201213587\MakerC3D\lib\JFlex_1.6.1\java-cup-11a.jar -parser parser -symbols sym sintactico.cup
pause